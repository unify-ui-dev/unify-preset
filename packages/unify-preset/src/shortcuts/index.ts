...
import { getGeneralShortcuts } from "./general";
...
export const getAllShortcut = ({ components, sharedElementVariant, baseUI, form, appearance }: { components?: Components, sharedElementVariant?: SharedVariant, baseUI?: BaseUI, form?: SharedFormConfig, appearance: Appearance }) => {
    ...
    const badge = getBadgeShortcuts(components?.badge, sharedElementVariant, { appearance })

    const accordion = getAccordionShortcuts(components?.accordion, sharedElementVariant, { appearance })
    const alert = getAlertShortcuts(components?.alert, sharedElementVariant, { appearance })
